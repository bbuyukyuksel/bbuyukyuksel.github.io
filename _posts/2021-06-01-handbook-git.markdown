...
toc: true
contents: 
- 1;Nedir Bu Kavramlar?;nedir-bu-kavramlar'
- 1;Yardım mı lazım?;yardım-mı-lazım'
- 1;Versiyon Öğrenme;versiyon-öğrenme'
- 1;Konfigürasyon;konfigürasyon'
- 2;Kendini tanıtmak;kendini-tanıtmak'
- 2;Editör Ayarı Yapmak;editör-ayarı-yapmak'
- 2;Parametrelerin tanımlandığı dosyaları öğrenmek;parametrelerin-tanımlandığı-dosyaları-öğrenmek'
- 2;Tanımlı parametreleri listelemek;tanımlı-parametreleri-listelemek'
- 1;Temel Komutlar;temel-komutlar'
- 2;$ git status;-git-status'
- 2;$ git add <DOSYA>;-git-add-dosya'
- 2;$ git add .;-git-add-'
- 2;$ git add *.cs;-git-add-cs'
- 2;$ git add -p <DOSYA>;-git-add--p-dosya'
- 2;$ git rm <DOSYA>;-git-rm-dosya'
- 2;$ git commit -m “<COMMIT MESAJI>”;-git-commit--m-commit-mesaji'
- 2;**$ git commit –allow-empty -m “”**;-git-commit-allow-empty--m-'
- 2;$ git log;-git-log'
- 2;$ git log –oneline;-git-log-oneline'
- 2;$ git log –all –decorate –oneline –graph;-git-log-all-decorate-oneline-graph'
- 1;.gitignore Dosyası;gitignore-dosyası'
- 1;Etiketleme – Tagging;etiketleme--tagging'
- 2;Etiketleri Listeleme – Listing Tags;etiketleri-listeleme--listing-tags'
- 2;Etiketleri Oluşturma – Creating Tags;etiketleri-oluşturma--creating-tags'
- 2;Tag Paylaşma – Sharing Tags;tag-paylaşma--sharing-tags'
- 2;Etiketleri Silme – Deleting Tags;etiketleri-silme--deleting-tags'
- 2;Etiketler Arasında Geçiş Yapmak – Checking out Tags;etiketler-arasında-geçiş-yapmak--checking-out-tags'
- 1;Takma İsimler – Aliases;takma-i̇simler--aliases'
- 1;Geçici Kaydetme – Stash;geçici-kaydetme--stash'
- 2;$ git stash;-git-stash'
- 2;$ git stash save “<STASH MESAJI>”;-git-stash-save-stash-mesaji'
- 2;$ git stash list;-git-stash-list'
- 2;$ git stash pop;-git-stash-pop'
- 2;$ git stash apply stash@{<ID>};-git-stash-apply-stashid'
- 1;Backtracking;backtracking'
- 2;Staging alanına taşınmış dosyaların Unstage edilmesi;staging-alanına-taşınmış-dosyaların-unstage-edilmesi'
- 2;Dosya Değişiklerinin Geri Alınması;dosya-değişiklerinin-geri-alınması'
- 2;Commitler Arası Gezinme;commitler-arası-gezinme'
- 2;SOFT Reset;soft-reset'
- 2;HARD Reset;hard-reset'
- 1;Branches;branches'
- 2;Branchleri Listeleme;branchleri-listeleme'
- 2;Branch Oluşturma;branch-oluşturma'
- 2;Branchler Arasında Geçiş Yapmak;branchler-arasında-geçiş-yapmak'
- 2;Branch Silmek;branch-silmek'
- 2;Branch Adını Değiştirmek;branch-adını-değiştirmek'
- 2;Branch Değişikliklerini Başka Bir Branche Aktarmak;branch-değişikliklerini-başka-bir-branche-aktarmak'
- 1;Takım İşi;takım-i̇şi'
- 2;$ git clone <REMOTE REPO> <CLONE NAME>;-git-clone-remote-repo-clone-name'
- 2;$ git remote -v;-git-remote--v'
- 2;$ git fetch;-git-fetch'
- 2;$ git push origin <BRANCH NAME>;-git-push-origin-branch-name'
- 2;$ git merge origin/master;-git-merge-originmaster'
- 2;$ git rebase;-git-rebase'
- 2;$ git merge –abort;-git-merge-abort'
- 1;! Git: fetch and merge, don’t pull;-git-fetch-and-merge-dont-pull'
- 1;Remote;remote'
- 2;$ git remote;-git-remote'
- 2;$ git remote -v;-git-remote--v-1'
- 2;$ git remote add <kısa yol adı> <uzak depo adresi>;-git-remote-add-kısa-yol-adı-uzak-depo-adresi'
- 2;$ git remote rm <kısa yol adı>;-git-remote-rm-kısa-yol-adı'
- 2;$ git remote rename  ;-git-remote-rename--'
- 1;PULL;pull'
- 2;$ git pull;-git-pull'
- 2;$ git pull ;-git-pull-'
- 2;$ git pull –rebase ;-git-pull-rebase-'
- 1;PUSH;push'
- 2;$ git push;-git-push'
- 2;$ git push  ;-git-push--'
- 2;$ git push  -- all;-git-push-----all'
- 2;$ git push  -- tags;-git-push-----tags'
- 1;Shortcuts;shortcuts'
- 2;Merge İşlemi;merge-i̇şlemi'
- 2;Yanlış Atılan Commit Mesajını Düzeltmek;yanlış-atılan-commit-mesajını-düzeltmek'
- 2;Yanlış Branch’e Atılan Commit;yanlış-branche-atılan-commit'
- 2;Commitler Arası Gezinme;commitler-arası-gezinme-1'
- 1;Kaybedilen Commit’i Geri Almak;kaybedilen-commiti-geri-almak'
- 1;Git Mimarisi;git-mimarisi'
- 2;Hash İlişkileri;hash-i̇lişkileri'
- 2;Manuel Commit;manuel-commit'
- 1;Git Log-Live;git-log-live'
