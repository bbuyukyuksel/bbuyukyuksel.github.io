...
- 'Backtracking;geçici-kaydetme--stash'
- 'Branches;branches'
- 'Takım İşi;takım-i̇şi'
- '! Git: fetch and merge, dont pull;-git-fetch-and-merge-dont-pull'
- 'Remote;remote'
- 'PULL;pull'
- 'PUSH;push'
- 'Shortcuts;shortcuts'
- 'Kaybedilen Commiti Geri Almak;kaybedilen-commiti-geri-almak'
